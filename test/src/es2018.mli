...
module Make (M: Missing) : sig
  ...
  module[@js.scope "Intl"] Intl : sig
    module[@js.scope "PluralRulesOptions"] PluralRulesOptions : sig
      ...
      val t_0_to_js: t_0 -> Ojs.t
      val t_0_of_js: Ojs.t -> t_0
      val get_localeMatcher: t -> ([`L_s0_best_fit[@js "best fit"] | `L_s2_lookup[@js "lookup"]] [@js.enum]) [@@js.get "localeMatcher"]
      val set_localeMatcher: t -> ([`L_s0_best_fit | `L_s2_lookup] [@js.enum]) -> unit [@@js.set "localeMatcher"]
      val get_type: t -> ([`L_s1_cardinal[@js "cardinal"] | `L_s3_ordinal[@js "ordinal"]] [@js.enum]) [@@js.get "type"]
      val set_type: t -> ([`L_s1_cardinal | `L_s3_ordinal] [@js.enum]) -> unit [@@js.set "type"]
    end
    module[@js.scope "ResolvedPluralRulesOptions"] ResolvedPluralRulesOptions : sig
      ...
      val get_pluralCategories: t -> string list [@@js.get "pluralCategories"]
      val set_pluralCategories: t -> string list -> unit [@@js.set "pluralCategories"]
      val get_type: t -> ([`L_s1_cardinal[@js "cardinal"] | `L_s3_ordinal[@js "ordinal"]] [@js.enum]) [@@js.get "type"]
      val set_type: t -> ([`L_s1_cardinal | `L_s3_ordinal] [@js.enum]) -> unit [@@js.set "type"]
    ...
    module[@js.scope "PluralRules"] PluralRules : sig
      ...
      val select: t -> n:float -> string [@@js.call "select"]
    end
